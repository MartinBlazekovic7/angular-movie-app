...
export class HomeComponent implements OnInit {
  ...
  constructor(private movieService: MoviesService, private showService: ShowsService, private peopleService: PeopleService) { }
  ...
  ngOnInit(): void {
    ...
    setInterval(()=> { this.nextSlideMovie() }, 10000);
    setInterval(()=> { this.nextSlideShow() }, 8000);
  }
